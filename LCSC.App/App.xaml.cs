...
namespace LCSC.App
{
    ...
    public partial class App : Application
    {
        ...
        private static ServiceProvider ConfigureServices(IConfiguration configuration)
            ...
            .AddSingleton(sp => new CommunityDataService(sp.GetRequiredService<LadderService>(), configuration["AirBaseSettings:token"], configuration["AirBaseSettings:baseId"], Package.Current.InstalledLocation.Path))
